    ...
    this.replayInterval.push({
      ...
      interval: setInterval(() => {
        if (
          ...
          this._player.getDuration() - Number(num)
        ) {
          this.seek(0);
  ...
  _optimizeDisplayHandler(anchor) {
    ...
    if (YTPlayer) {
      ...
      if (el) {
        ...
        vid.style.height =
          Math.ceil(parseFloat(vid.style.width, 10) / ratio) + "px";
        vid.style.marginTop =
          Math.ceil(-((parseFloat(vid.style.height, 10) - win.height) / 2)) +
          "px";
        ...
        if (lowest) {
          (vid.style.height = win.height + "px"),
            (vid.style.width =
              Math.ceil(parseFloat(vid.style.height, 10) * ratio) + "px"),
            (vid.style.marginTop = 0),
            (vid.style.marginLeft =
              Math.ceil(-((parseFloat(vid.style.width, 10) - win.width) / 2)) +
              "px");
        }
        for (const align in YTPAlign)
          if (YTPAlign.hasOwnProperty(align)) {
            ...
            switch (al) {
              case "top":
                vid.style.marginTop = lowest
                  ? -((parseFloat(vid.style.height, 10) - win.height) / 2) +
                    "px"
                  : 0;
                break;
              case "bottom":
                vid.style.marginTop = lowest
                  ? 0
                  : -(parseFloat(vid.style.height, 10) - win.height) + "px";
                break;
              case "left":
                vid.style.marginLeft = 0;
                break;
              case "right":
                vid.style.marginLeft = lowest
              ...
              default:
                parseFloat(vid.style.width, 10) > win.width &&
                  (vid.style.marginLeft =
                    -((parseFloat(vid.style.width, 10) - win.width) / 2) +
                    "px");
            }
          }
      }
